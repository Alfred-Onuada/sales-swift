! function(e) {
	...
	var p = {
		...
		b = {
			"Close submenu": "Ãâ€”ÃÂ°ÃÂºÃ‘â‚¬Ã‘â€¹Ã‘â€šÃ‘Å’ ÃÂ¿ÃÂ¾ÃÂ´ÃÂ¼ÃÂµÃÂ½Ã‘Å½",
			Menu: "ÃÅ“ÃÂµÃÂ½Ã‘Å½",
			"Open submenu": "ÃÅ¾Ã‘â€šÃÂºÃ‘â‚¬Ã‘â€¹Ã‘â€šÃ‘Å’ ÃÂ¿ÃÂ¾ÃÂ´ÃÂ¼ÃÂµÃÂ½Ã‘Å½",
			"Toggle submenu": "ÃÅ¸ÃÂµÃ‘â‚¬ÃÂµÃÂºÃÂ»Ã‘Å½Ã‘â€¡ÃÂ¸Ã‘â€šÃ‘Å’ ÃÂ¿ÃÂ¾ÃÂ´ÃÂ¼ÃÂµÃÂ½Ã‘Å½"
		},
		v = {
			"Close submenu": "ZatvoriÃ…Â¥ submenu",
			Menu: "Menu",
			"Open submenu": "OtvoriÃ…Â¥ submenu",
			"Toggle submenu": "PrepnÃƒÂºÃ…Â¥ submenu"
		};
	const g = e => {
			const t = e.split("."),
	...
	let S = {};
	const M = (e, t, n) => {
			"number" == typeof e && (e = "(min-width: " + e + "px)"), S[e] = S[e] || [], S[e].push({
				yes: t,
				no: n
			})
		},
	...
	class O {
		constructor(e, t, n) {
			return x.set(this, void 0), T.set(this, void 0), A.set(this, void 0), this.opts = a(t, s), this.conf = a(n, i), this._api = ["i18n", "bind", "openPanel", "closePanel", "setSelected"], this.node = {}, this.hook = {}, this.node.menu = "string" == typeof e ? document.querySelector(e) : e, "function" == typeof this._deprecatedWarnings && this._deprecatedWarnings(), this.trigger("init:before"), this._initObservers(), this._initAddons(), this._initHooks(), this._initAPI(), this._initMenu(), this._initPanels(), this._initOpened(), (() => {
				for (let e in S) {
		...
		openPanel(e, t = !0, n = !0) {
			...
			if (s) {
				...
				const s = ["mm-panel--opened", "mm-panel--parent"],
					i = [];
				t ? s.push("mm-panel--noanimation") : i.push("mm-panel--noanimation"), _(this.node.pnls, ".mm-panel").forEach(t => {
				...
				for (; a;) a = a.closest(".mm-panel"), a.classList.add("mm-panel--parent"), a = L(this.node.pnls, "#" + a.dataset.mmParent)[0]
			}
		...
		_initMenu() {
			this.trigger("initMenu:before"), this.node.wrpr = this.node.wrpr || this.node.menu.parentElement, this.node.wrpr.classList.add("mm-wrapper"), this.node.menu.classList.add("mm-menu"), this.node.menu.id = this.node.menu.id || r(), this.node.menu.setAttribute("aria-label", this.i18n(this.opts.navbar.title || "Menu")), this.node.menu.setAttribute("aria-modal", "true"), this.node.menu.setAttribute("role", "dialog");
		...
		_initPanel(e) {
			var t;
			if (!e.matches(".mm-panel") && (P(e, this.conf.classNames.panel, "mm-panel"), P(e, this.conf.classNames.nopanel, "mm-nopanel"), !e.matches(".mm-nopanel"))) {
		...
		_initListview(e) {
			["htmlulistelement", "htmlolistelement"].includes(o(e)) && (e.matches(".mm-listview") || (P(e, this.conf.classNames.nolistview, "mm-nolistview"), e.matches(".mm-nolistview") || (this.trigger("initListview:before", [e]), e.classList.add("mm-listview"), _(e).forEach(e => {
				this._initListitem(e)
			}), N(this, T).observe(e, {
				childList: !0
		...
		_initListitem(e) {
			["htmllielement"].includes(o(e)) && (e.matches(".mm-listitem") || (P(e, this.conf.classNames.divider, "mm-divider"), e.matches(".mm-divider") || (this.trigger("initListitem:before", [e]), e.classList.add("mm-listitem"), P(e, this.conf.classNames.selected, "mm-listitem--selected"), _(e, "a, span").forEach(e => {
	...
	x = new WeakMap, T = new WeakMap, A = new WeakMap, O.addons = {}, O.node = {}, O.vars = {};
	var j = {
		use: !0,
		position: "left"
	};
	...
	O.prototype.position = function(e = null) {
		...
		q.includes(e) && (this.node.wrpr.classList.remove("mm-wrapper--position-" + t.position), this.node.wrpr.classList.add("mm-wrapper--position-" + e), this.node.menu.classList.remove("mm-menu--position-" + t.position), this.node.menu.classList.add("mm-menu--position-" + e), t.position = e)
	...
	function z() {
		this.opts.navbars = this.opts.navbars || [], this.conf.navbars = this.conf.navbars || {}, a(this.conf.navbars, W);
	...
	var G = {
		...
		K = {
			...
			"Cancel searching": "Ã™â€žÃ˜ÂºÃ™Ë† Ã˜Â¬Ã˜Â³Ã˜ÂªÃ˜Â¬Ã™Ë†",
			"Clear searchfield": "Ã™Â¾Ã˜Â§ÃšÂ© ÃšÂ©Ã˜Â±Ã˜Â¯Ã™â€  Ã™ÂÃ›Å’Ã™â€žÃ˜Â¯ Ã˜Â¬Ã˜Â³Ã˜ÂªÃ˜Â¬Ã™Ë†",
		...
		Q = {
			cancel: "ÃÂ¾Ã‘â€šÃÂ¼ÃÂµÃÂ½ÃÂ¸Ã‘â€šÃ‘Å’",
			"Cancel searching": "ÃÅ¾Ã‘â€šÃÂ¼ÃÂµÃÂ½ÃÂ¸Ã‘â€šÃ‘Å’ ÃÂ¿ÃÂ¾ÃÂ¸Ã‘ÂÃÂº",
			"Clear searchfield": "ÃÅ¾Ã‘â€¡ÃÂ¸Ã‘ÂÃ‘â€šÃÂ¸Ã‘â€šÃ‘Å’ ÃÂ¿ÃÂ¾ÃÂ»ÃÂµ ÃÂ¿ÃÂ¾ÃÂ¸Ã‘ÂÃÂºÃÂ°",
			"No results found.": "ÃÂÃÂ¸Ã‘â€¡ÃÂµÃÂ³ÃÂ¾ ÃÂ½ÃÂµ ÃÂ½ÃÂ°ÃÂ¹ÃÂ´ÃÂµÃÂ½ÃÂ¾.",
			Search: "ÃÂÃÂ°ÃÂ¹Ã‘â€šÃÂ¸"
		},
		ee = {
			cancel: "zruÃ…Â¡iÃ…Â¥",
			"Cancel searching": "ZruÃ…Â¡iÃ…Â¥ vyhÃ„Â¾adÃƒÂ¡vanie",
			"Clear searchfield": "VymazaÃ…Â¥ pole vyhÃ„Â¾adÃƒÂ¡vania",
			"No results found.": "Neboli nÃƒÂ¡jdenÃƒÂ© Ã…Â¾iadne vÃƒÂ½sledky.",
			Search: "VyhÃ„Â¾adÃƒÂ¡vanie"
		};
	h({
		cancel: "abbrechen",
		"Cancel searching": "Suche abbrechen",
		"Clear searchfield": "Suchfeld lÃƒÂ¶schen",
		"No results found.": "Keine Ergebnisse gefunden.",
		Search: "Suche"
	}, "de"), h(K, "fa"), h(X, "nl"), h(J, "pt_br"), h(Q, "ru"), h(ee, "sk");
	const te = function() {
			const e = this.opts.searchfield,
				t = this.conf.searchfield;
			let n = _(this.node.pnls, ".mm-panel--search")[0];
			return n || (n = g("div.mm-panel--search"), me(n, t.panel), e.title.length && (n.dataset.mmTitle = this.i18n(e.title)), n.append(g("ul")), this._initPanel(n), n)
		},
		ne = function(e) {
			...
			if (e.matches(t.addTo)) {
				...
				if (!L(e, ".mm-searchfield").length) {
					...
					t && n.classList.add("mm-searchfield--cancelable"), e.prepend(n), ie.call(this, n)
				}
			}
		...
		se = function(e = !1) {
			...
			s.append(i);
			const a = g("input");
			if (i.append(a), a.type = "text", a.autocomplete = "off", a.placeholder = this.i18n(t.placeholder), a.setAttribute("aria-label", this.i18n(t.placeholder)), me(a, n.input), n.submit) {
		...
		ie = function(e) {
			...
			const a = () => {
				...
				if (i.forEach(e => {
					...
					let t = 0;
					t = n.matches(".mm-panel--search") ? ae(n, a, i) : re(a, i), n.classList[0 == t ? "add" : "remove"]("mm-panel--noresults"), this.trigger("search:after")
				} else this.trigger("clear:before"), e.classList.remove("mm-searchfield--searching"), n.classList.remove("mm-panel--searching", "mm-panel--noresults"), n.matches(".mm-panel--search") ? (oe(n), t.splash || this.closePanel(n, !1, !1)) : le(i), this.trigger("clear:after")
			};
		...
		re = (e, t) => {
			...
			return t.forEach(t => {
				...
				n += s.length, s.length && s.forEach(t => {
					...
					t.classList.add("mm-hidden"), t.dataset.mmSearchresult === e && [t, ...w(t, ".mm-listitem")].forEach(e => {
	...
	O.addons = {
		offcanvas: function() {
			...
			e.use && (q.includes(e.position) || (e.position = q[0]), this._api.push("open", "close", "setPage", "position"), this.bind("initMenu:before", () => {
				...
				e.id = r(), e.setAttribute("aria-label", this.i18n(t.screenReader.closeMenu)), e.setAttribute("inert", "true"), document.querySelector(t.menu.insertSelector).append(e), O.node.blck = e
			}), this.bind("initMenu:after", () => {
				this.setPage(O.node.page), this.node.menu.classList.add("mm-menu--offcanvas"), this.node.menu.setAttribute("inert", "true"), this.position(e.position);
		...
		scrollBugFix: function() {
			...
			this.node.menu.addEventListener("scroll", e => {
				...
				n && n.closest(".mm-listitem--vertical") && (n = w(n, ".mm-panel").pop()), n ? (n.scrollHeight === n.offsetHeight || 0 == n.scrollTop && "down" == e.get() || n.scrollHeight == n.scrollTop + n.offsetHeight && "up" == e.get()) && t.stopPropagation() : t.stopPropagation()
			}, {
				passive: !1
		...
		iconbar: function() {
			...
			if (["top", "bottom"].forEach((n, s) => {
				...
				if ("boolean" == typeof e.use ? this.bind("initMenu:after", s) : M(e.use, s, i), "tabs" == e.type) {
		...
		searchfield: function() {
			...
			if (e.add) {
				...
				this.bind("initPanel:after", t => {
					...
					ne.call(this, t), L(this.node.menu, e.addTo).forEach(n => {
		...
		sidebar: function() {
			...
			if (e.expanded.use) {
				...
				let t = !1,
					n = () => {
						t = !0, this.node.wrpr.classList.add("mm-wrapper--sidebar-expanded"), this.node.menu.removeAttribute("aria-modal"), this.open(), O.node.page.removeAttribute("inert")
					},
					s = () => {
						t = !1, this.node.wrpr.classList.remove("mm-wrapper--sidebar-expanded"), this.node.menu.setAttribute("aria-modal", "true"), this.close()
					};
				"boolean" == typeof e.expanded.use ? this.bind("initMenu:after", n) : M(e.expanded.use, n, s), this.bind("close:after", () => {
					t && window.sessionStorage.setItem("mmenuExpandedState", "closed")
				}), this.bind("open:after", () => {
					t && (window.sessionStorage.setItem("mmenuExpandedState", "open"), O.node.page.removeAttribute("inert"))
				});
